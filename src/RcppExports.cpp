...
RcppExport SEXP _tsCeatures_histogram_mode_10(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
    rcpp_result_gen = Rcpp::wrap(histogram_mode_10(x));
    return rcpp_result_gen;
END_RCPP
}
// histogram_mode_5
double histogram_mode_5(NumericVector x);
RcppExport SEXP _tsCeatures_histogram_mode_5(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< NumericVector >::type x(xSEXP);
    rcpp_result_gen = Rcpp::wrap(histogram_mode_5(x));
    return rcpp_result_gen;
END_RCPP
}
// kurtosis
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_tsCeatures_histogram_mode_10", (DL_FUNC) &_tsCeatures_histogram_mode_10, 1},
    {"_tsCeatures_histogram_mode_5", (DL_FUNC) &_tsCeatures_histogram_mode_5, 1},
