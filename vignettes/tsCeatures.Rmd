...
`tsCeatures` is a simple R package for the computation of a few time-series features coded in C++ for scalability and efficiency. The name is a meme on the `tsfeatures` naming convention in the time series software world. You can install `tsCeatures` from GitHub:
